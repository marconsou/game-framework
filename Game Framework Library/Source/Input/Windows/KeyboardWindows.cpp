...
namespace gfl
{
	...
	bool KeyboardWindows::IsKeyboardKey(KeyboardKey key, InputState state)
	{
	...
	void KeyboardWindows::ProcessMessage(UINT message, WPARAM wParam, LPARAM lParam)
	{
