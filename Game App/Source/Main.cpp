...
LPCWSTR g_szAppName = L"DirectX 12 App";
...
int AppMain::Run()
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = WindowsApi::GetExecutableId().data();//L"DirectX_12_AppWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, wcex.lpszClassName, g_szAppName, WS_OVERLAPPEDWINDOW,
            ...
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"DirectX_12_AppWindowClass", g_szAppName, WS_POPUP,
    ...
    c.Alpha = 123;
    auto t = ColorPalette::AliceBlue;
    const auto id = WindowsApi::GetExecutableId();
    const auto path = WindowsApi::GetExecutablePath();
